...
#define ADS_EXT_IRQ(x)		(IRQ_BOARD_START + (x))
...
#define IRQ_JORNADA_KEY_ROW0	(IRQ_BOARD_END + 32 + 6) /* GPIO B(6) */
#define IRQ_JORNADA_KEY_ROW1	(IRQ_BOARD_END + 32 + 7) /* GPIO B(7) */
#define IRQ_JORNADA_KEY_ROW2	(IRQ_BOARD_END + 32 + 8) /* GPIO B(8) */
