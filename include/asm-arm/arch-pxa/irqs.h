...
#ifdef CONFIG_CPU_BULVERDE
#define IRQ_OST_4_11	PXA_IRQ(7)	/* OS timer 4-11 matches*/
#else
...
#ifdef CONFIG_CPU_BULVERDE
#define IRQ_USIM	PXA_IRQ(15)	/* Smart Card interface interrupt */
#define IRQ_SSP2	PXA_IRQ(16)	/* SSP2 interrupt */
#else
...
#ifdef CONFIG_CPU_BULVERDE
#define IRQ_GPIO_LAST	IRQ_GPIO(127)
#else
#define IRQ_GPIO_LAST	IRQ_GPIO(95)
#endif

#undef NR_IRQS
#define	NR_IRQS		(IRQ_GPIO_LAST + 1)

#if defined(CONFIG_SA1111)

#define IRQ_SA1111_START	(IRQ_GPIO_LAST + 1)
...
#else
#define LUBBOCK_IRQ(x)	(IRQ_GPIO_LAST + 1 + (x))
#endif
...
#define MAINSTONE_IRQ(x)	(IRQ_GPIO_LAST + 1 + (x))
...
#undef NR_IRQS
#define NR_IRQS		(MAINSTONE_IRQ(15) + 1)
