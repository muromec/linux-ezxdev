...
#define MCR_AFE         (1 << 5)        /* Autoflow control */
 ...
 * PXA250 and Bulverde USB device controller registers are different.
 */
...
#else /* ifdef CONFIG_CPU_BULVERDE */
...
#define RTSR_SWALE2     (1 << 11)       /* Stopwatch Alarm Enable 2 */
#define RTSR_SWAL2      (1 << 10)       /* Stopwatch Alarm 2 status */
#define RTSR_SWALE1     (1 << 9)        /* Stopwatch Alarm Enable 1 */
...
#define GPIO19_L_CS			19  /*LCD L_CS*/
#define GPIO19_CLI_RESET		19  /*CLI RESET*/
...
#define GPIO49_LCD_MUX   49	/*LCD MUX*/
#define GPIO49_CLI_RESET 49	/*CLI RESET*/
...
#define GPIO78_LCD_SD	78	/*LCD_SD*/	
#define GPIO79_LCD_CM	79	/*LCD_CM*/	
#define GPIO79_pSKTSEL		79	/* Socket Select for Card Space */
#define GPIO80_nCS_4		80	/* chip select 4 */
#define GPIO85_nPCE_1		85	/* Card Enable for Card Space */
#define GPIO86_LDD_16 	86	/*LDD16*/
#define GPIO87_LDD_17 	87	/*LDD17*/

#define GPIO30_USB_P3_2	 	30      /*USB_P3_2/ICL_TXENB*/
#define GPIO31_USB_P3_6         31      /*USB_P3_6/ICL_VPOUT*/
#define GPIO90_USB_P3_5         90      /*USB_P3_5/ICL_VPIN*/
#define GPIO91_USB_P3_1	 	91   	/*USB_P3_1/ICL_XRXD*/
#define GPIO56_USB_P3_4 	56      /*USB_P3_4/ICL_VMOUT*/
#define GPIO113_USB_P3_3	113 	/*USB_P3_3/ICL_VMIN*/
...
#define GPIO19_L_CS_MD		(19 | GPIO_ALT_FN_2_OUT) 
...
#define GPIO117SCL          (117 | GPIO_ALT_FN_1_OUT)
#define GPIO118SDA          (118 | GPIO_ALT_FN_1_OUT)
...
#define PEDR_GPIO0	(1 << 0)	/*Wake up by gpio 0[bp_rdy]*/
#define PEDR_EDRTC      (1 << 31)       /* Wake up by RTC */
...
#define CKEN31_AC97CONF (1 << 31)       /* AC97 Controller Configuration */
...
/*These definitions are for CLI smart panel */
#ifdef CONFIG_CPU_BULVERDE
...
#define FSADR6          __REG(0x44000264)  /* DMA Channel 6 Frame Source Address Register */
#define FIDR6           __REG(0x44000268)  /* DMA Channel 6 Frame ID Register */
#define LDCMD6          __REG(0x4400026C)  /* DMA Channel 6 Command Register */
...
#define LCDBSCR         __REG(0x48000054)  /* LCD buffer strength register */
...
#if defined(CONFIG_ARCH_MAINSTONE) || defined(CONFIG_ARCH_EZX)
...
#define LCSR0_EOF	(1 << 8)	/* end of frame */
#define LCSR0_BS	(1 << 9)	/* branch status */
#define LCSR0_SINT	(1 << 10)	/* subsequent interrupt */
#define LCSR0_CMD_INT	(1 << 12)	/* command interrupt */
...
#define MDREFR_RESERVED 0x1c201000      /* reserved bits */
...
/*	This is Motorola - EZX sound driver specif stuff		*/

#define DRCMR66		__REG(0x40001108)  /* Request to Channel Map Register for ASSP receive Request */
#define DRCMR67		__REG(0x4000110c)  /* Request to Channel Map Register for ASSP transmit Request */

#define DRCMRRXMODR	DRCMR9

/* DMA DCRMR  for NSSP */
#define DRCMRRXNSSDR     DRCMR15
#define DRCMRTXNSSDR     DRCMR16


/* DMA DCRMR  for ASSP */
#define DRCMRRXASSDR     DRCMR66
#define DRCMRTXASSDR     DRCMR67

#define DCMD_RXSADR     (DCMD_INCTRGADDR|DCMD_FLOWSRC|DCMD_BURST32|DCMD_WIDTH4)
#define DCMD_TXSADR     (DCMD_INCSRCADDR|DCMD_FLOWTRG|DCMD_BURST32|DCMD_WIDTH4)

//width=0b10, 16bit
#define DCMD_RXNSSDR    (DCMD_INCTRGADDR|DCMD_FLOWSRC|DCMD_BURST16|DCMD_WIDTH2)
#define DCMD_TXNSSDR    (DCMD_INCSRCADDR|DCMD_FLOWTRG|DCMD_BURST16|DCMD_WIDTH2)

//write: width=0b11, 32bit
//read: width=0b10, 16bit
#define DCMD_RXASSDR    (DCMD_INCTRGADDR|DCMD_FLOWSRC|DCMD_BURST16|DCMD_WIDTH2)
#define DCMD_TXASSDR    (DCMD_INCSRCADDR|DCMD_FLOWTRG|DCMD_BURST32|DCMD_WIDTH4)
#define DCMD_TXASSDRM    (DCMD_INCSRCADDR|DCMD_FLOWTRG|DCMD_BURST16|DCMD_WIDTH2)  

#define UP2OCR          __REG(0x40600020) /* USB Port 2 OCR */
#define UP3OCR          __REG(0x40600024) /* USB Port 3 OCR */
#define UDCWAKEUP       __REG(0x40F00044) /* UDC Wakeup Register (?) */




/*
 *  * SSP Serial Port Registers, used by pcap driver.
 *   */
...
/*define SSP for blverde */
#define NSSCR0          __REG(0x41700000)  /* SSP2:NSSP control register 0 */
#define NSSCR0_EDSS	(1 << 20)	/* set DSS range 17-32 bit */
#define NSSCR0_SCR	(1 << 8)	/* set sspsclk rate */  ///?????
#define NSSCR0_SSE	(1 << 7)	/* SSP enable */
#define NSSCR0_FRF_SPI		0x0 		/* SPI mode */
#define NSSCR0_FRF_TI		0x10		/* TI mode */
#define NSSCR0_FRF_MICROWIRE	0x20		/* MICROWIRE mode */
#define NSSCR0_FRF_PSP		0x30		/* PSP mode */
#define NSSCR0_DSS_32bit	0xF		/* 32bit data */
#define NSSCR0_DSS_16bit 	0xF		/* 16bit data */
#define NSSCR0_DSS_8bit 	0x7		/* 7bit data */
#define NSSCR0_FRDC_4	(0x3 << 24)
#define NSSCR0_MOD_NET	(0x1 << 31)
#define NSSCR1          __REG(0x41700004)  /* NSSP control register 1 */
#define NSSCR1_TTELP	(1 << 31)	/* SSP TXD hi-z timing extended 1/2 phase */
#define NSSCR1_TTE	(1 << 30)	/* SSP TXD hi-z when idle */
#define NSSCR1_EBCEI	(1 << 29)	/* bit count error not generate interrupt */
#define NSSCR1_SCFR	(1 << 28)	/* clock input active only transfer */
#define NSSCR1_SCLKDIR	(1 << 25)	/* bit rate clock slave mode */
#define NSSCR1_SFRMDIR	(1 << 24)	/* frame slave mode */
#define NSSCR1_RWOT	(1 << 23)	/* receive without transmit mode */
#define NSSCR1_TSRE	(1 << 21)	/* transmit DMA request enable */
#define NSSCR1_RSRE	(1 << 20)	/* receive  DMA request enable */
#define NSSCR1_TINTE	(1 << 19)	/* receive timeout interrupt enable */
#define NSSCR1_STRF	(1 << 15)	/* receive FIFO in test mode */
#define NSSCR1_EFWR	(1 << 14)	/* FIFO read/write in test mode */
#define NSSCR1_RFTH_14	(0xD << 10)		/* receive threshold=13+1 */
#define NSSCR1_RFTH_12	(0xB << 10)		/* receive threshold=11+1 */
#define NSSCR1_TFTH_14	(0xE << 6)		/* transmit threshold=14+1 */	
#define NSSCR1_TFTH_8	(0x8 << 6)		/* transmit threshold=8 */	
#define NSSCR1_TFTH_4	(0x4 << 6)		/* transmit threshold=4 */	
#define NSSCR1_TFTH_1	(0x1 << 6)		/* transmit threshold=1+1 */	
#define NSSCR1_MWDS	(1 << 5)	/* 16bit command for Microwire */
#define NSSCR1_SPH	(1 << 4)	/* sspsclk phase setting */
#define NSSCR1_SPO	(1 << 3)	/* sspsclk polarity setting */
#define NSSCR1_LBM	(1 << 2)	/* loopback mode */
#define NSSCR1_TIE	(1 << 1)	/* transmit FIFO interrupt enable */
#define NSSCR1_RIE	(1 << 0)	/* receive FIFO interrupt enable */
#define NSSSR		__REG(0x41700008)  /* NSSP status register */
#define NSSSR_BCE	(1 << 23)	/* SSPSFRM assert out of sync */
#define NSSSR_CSS	(1 << 22)	/* SSP busy sync slave mode */
#define NSSSR_TUR	(1 << 21)	/* transmit FIFO underrun */
#define NSSSR_TINT	(1 << 19)	/* receive timeout pending */
#define NSSSR_RFL_MASK	(0xF << 12)	/* receive FIFO level */
#define NSSSR_TFL_MASK	(0xF << 8)	/* transmit FIFO level */
#define NSSSR_ROR	(1 << 7)	/* receive FIFO overrun */
#define NSSSR_RFS	(1 << 6)	/* receive FIFO above RFT */
#define NSSSR_TFS	(1 << 5)	/* transmit FIFO below TFT */
#define NSSSR_BSY	(1 << 4)	/* SSP port busy */
#define NSSSR_RNE	(1 << 3)	/* receive FIFO not empty */
#define NSSSR_TNE	(1 << 2)	/* transmit FIFO not full */
#define NSSITR		__REG(0x4170000C)  /* NSSP interrupt test register */
#define NSSITR_TROR	(1 << 7)	/* test receive FIFO overrun */
#define NSSITR_TRFS	(1 << 6)	/* test receive FIFO service request */
#define NSSITR_TTFS	(1 << 5)	/* test transmit FIFO service request */
#define NSSDR      	__REG(0x41700010)  /* NSSP data register */
#define NSSTO		__REG(0x41700028)  /* NSSP time out register */
#define NSSTO_1S	0x1F40	/* 8k frequency 1S */
#define NSSPSP		__REG(0x4170002C)  /* NSSP programmable serial protocol */	
#define NSSPSP_DMYSTOP	(0 << 23)	//T4 
#define NSSPSP_SFRMWDTH_1	(1 << 16)	//T6
#define NSSPSP_SFRMWDTH_16	(16 << 16)	//T6
#define NSSPSP_SFRMWDTH	(16 << 16)	//T6
#define NSSPSP_SFRMDLY	(0 << 9)	//T5
#define NSSPSP_DMYSTRT	(0 << 7)	//T2
#define NSSPSP_DMYSTRT_1	(1 << 7)	//T2
#define NSSPSP_STRTDLY	(0 << 4)	//T1
#define NSSPSP_STRTDLY_1	(1 << 4)	//T1
#define NSSPSP_ETDS	(0 << 3)	
#define NSSPSP_SFRMP_LOW	(0 << 2)
#define NSSPSP_SFRMP_HIGH	(1 << 2)
#define NSSPSP_SCMODE	(2 << 0)
#define NSSTSA          __REG(0x41700030)
#define NSSTSA_TTSA_1   0x1
#define NSSTSA_TTSA_0   0x0
#define NSSRSA          __REG(0x41700034)
#define NSSRSA_RTSA_1   0x1
#define NSSRSA_RTSA_9   0x9

	/* for ASSP port register */
#define ASSCR0          __REG(0x41900000)  /* ASSP control register 0 */
#define ASSCR0_EDSS	(1 << 20)	/* set DSS range 17-32 bit */
#define ASSCR0_SCR	(1 << 8)	/* set sspsclk rate */
#define ASSCR0_SSE	(1 << 7)	/* SSP enable */
#define ASSCR0_FRF_SPI		0x0 		/* SPI mode */
#define ASSCR0_FRF_TI		0x10		/* TI mode */
#define ASSCR0_FRF_MICROWIRE	0x20		/* MICROWIRE mode */
#define ASSCR0_FRF_PSP		0x30		/* PSP mode */
#define ASSCR0_DSS_32bit	0xF		/* 32bit data */
#define ASSCR0_DSS_16bit 	0xF		/* 16bit data */
#define ASSCR0_DSS_8bit 	0x7		/* 7bit data */
#define ASSCR1          __REG(0x41900004)  /* ASSP control register 1 */
#define ASSCR1_TTELP	(1 << 31)	/* SSP TXD hi-z timing extended 1/2 phase */
#define ASSCR1_TTE	(1 << 30)	/* SSP TXD hi-z when idle */
#define ASSCR1_EBCEI	(1 << 29)	/* bit count error not generate interrupt */
#define ASSCR1_SCFR	(1 << 28)	/* clock input active only transfer */
#define ASSCR1_SCLKDIR	(1 << 25)	/* bit rate clock slave mode */
#define ASSCR1_SFRMDIR	(1 << 24)	/* frame slave mode */
#define ASSCR1_RWOT	(1 << 23)	/* receive without transmit mode */
#define ASSCR1_TSRE	(1 << 21)	/* transmit DMA request enable */
#define ASSCR1_RSRE	(1 << 20)	/* receive  DMA request enable */
#define ASSCR1_TINTE	(1 << 19)	/* receive timeout interrupt enable */
#define ASSCR1_STRF	(1 << 15)	/* receive FIFO in test mode */
#define ASSCR1_EFWR	(1 << 14)	/* FIFO read/write in test mode */
#define ASSCR1_RFTH_14	(0xE << 10)		/* receive threshold=14+1 */
#define ASSCR1_TFTH_14	(0xE << 6)		/* transmit threshold=14+1 */	
#define ASSCR1_TFTH_8	(0x8 << 6)		/* transmit threshold=8+1 */	
#define ASSCR1_TFTH_4	(0x4 << 6)		/* transmit threshold=4+1 */	
#define ASSCR1_TFTH_1	(0x1 << 6)		/* transmit threshold=1+1 */	
#define ASSCR1_MWDS	(1 << 5)	/* 16bit command for Microwire */
#define ASSCR1_SPH	(1 << 4)	/* sspsclk phase setting */
#define ASSCR1_SPO	(1 << 3)	/* sspsclk polarity setting */
#define ASSCR1_LBM	(1 << 2)	/* loopback mode */
#define ASSCR1_TIE	(1 << 1)	/* transmit FIFO interrupt enable */
#define ASSCR1_RIE	(1 << 0)	/* receive FIFO interrupt enable */
#define ASSSR		__REG(0x41900008)  /* ASSP status register */
#define ASSSR_BCE	(1 << 23)	/* SSPSFRM assert out of sync */
#define ASSSR_CSS	(1 << 22)	/* SSP busy sync slave mode */
#define ASSSR_TUR	(1 << 21)	/* transmit FIFO underrun */
#define ASSSR_TINT	(1 << 19)	/* receive timeout pending */
#define ASSSR_RFL_MASK	(0xF << 12)	/* receive FIFO level */
#define ASSSR_TFL_MASK	(0xF << 8)	/* transmit FIFO level */
#define ASSSR_ROR	(1 << 7)	/* receive FIFO overrun */
#define ASSSR_RFS	(1 << 6)	/* receive FIFO above RFT */
#define ASSSR_TFS	(1 << 5)	/* transmit FIFO below TFT */
#define ASSSR_BSY	(1 << 4)	/* SSP port busy */
#define ASSSR_RNE	(1 << 3)	/* receive FIFO not empty */
#define ASSSR_TNF	(1 << 2)	/* transmit FIFO not full */
#define ASSITR		__REG(0x4190000C)  /* ASSP interrupt test register */
#define ASSITR_TROR	(1 << 7)	/* test receive FIFO overrun */
#define ASSITR_TRFS	(1 << 6)	/* test receive FIFO service request */
#define ASSITR_TTFS	(1 << 5)	/* test transmit FIFO service request */
#define ASSDR      	__REG(0x41900010)  /* ASSP data register */
#define ASSTO		__REG(0x41900028)  /* ASSP time out register */
#define ASSTO_1S	0x1F40	/* 8k frequency 1S */
#define ASSPSP		__REG(0x4190002C)  /* ASSP programmable serial protocol */	
#define ASSPSP_DMYSTOP		(0 << 23)	//T4 
#define ASSPSP_SFRMWDTH_1	(1 << 16)	//T6
#define ASSPSP_SFRMWDTH_16	(16 << 16)	//T6
#define ASSPSP_SFRMDLY		(0 << 9)	//T5
#define ASSPSP_DMYSTRT		(0 << 7)	//T2
#define ASSPSP_STRTDLY		(0 << 4)	//T1
#define ASSPSP_STRTDLY_1	(1 << 4)	//T1
#define ASSPSP_ETDS		(0 << 3)	
#define ASSPSP_SFRMP_LOW	(0 << 2)
#define ASSPSP_SFRMP_HIGH	(1 << 2)
#define ASSPSP_SCMODE		(2 << 0)

#define MMC_CMDAT_RES_REG       (2 << 0)        /*      CID/CSD response */

#define CKEN9_OST	(1 << 9)	/* OS Timer Unit Clock Enable */

#define CKEN4_ASSP      (1 << 4)        /* ASSP unit clock enable */
#define CKEN3_NSSP	(1 << 3)	/* NSSP unit clock enable */
