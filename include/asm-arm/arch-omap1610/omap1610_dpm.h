/*
 * include/asm-arm/arch-omap1610/innovator_dpm.h  
...
#include <asm/arch-omap1610/ck.h>
#include <asm/arch-omap1610/preem_latency.h>
...
void dpm_omap1610_board_setup(void);

typedef void (*dpm_fscaler)(struct dpm_regs *regs);

#define basic_idle(parms) omap1610_pm_idle(void)
