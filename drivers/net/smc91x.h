...
#define SMC_IOADDR		(PERSEUS2_FPGA_ETHR_BASE + 0x300)
#define SMC_IRQ			INT_P2_ETHR
#endif
...
#ifdef SMC_insl
#undef SMC_insl
#define SMC_insl(a, r, p, l)	smc_pxa_dma_insl(a, r, dev, p, l)
#endif

#ifdef SMC_outsl
#undef SMC_outsl
#define SMC_outsl(a, r, p, l)	smc_pxa_dma_outsl(a, r, dev, p, l)
#endif
