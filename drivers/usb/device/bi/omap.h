 ...
 * Register definitions for TI OMAP1510/1610/730 USB bus interface driver
 *
...
#define UDC_NAME                     "TI OMAP730 USBD"	/* Name of this UDC */
#define UDC_IRQ                      INT_USB_Geni	/* General UDC interrupt (IH2_BASE + 29) */
#define UDC_SOF_IRQ                  INT_USB_ISO	/* Start-of-frame interrupt for ISO trns (IH1_BASE +  3) */
#define UDC_NONISO_IRQ               INT_USB_NON_ISO	/* Non-ISO endpoint-specific interrupt (IH1_BASE +  2) */
#define UDC_MAX_ENDPOINTS            31
#else
#define UDC_NAME                     "TI OMAP1510/1610 USBD"	/* Name of this UDC */
...
/* The 730 TRM (& 1610 for that matter) state that DMAN_STAT is at 0x38 and
 * 3C is reserved
 */
#if defined(CONFIG_ARCH_OMAP730)
#define UDC_DMAN_STAT                UDC_OFFSET(0x38)	/* DMA endpoint interrupt status */
#else
