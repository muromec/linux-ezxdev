/****************************************************************************
 *
 *      ibmcsiti.h : IBM PPC 405LP Codec Serial Interface (CSI) +
 *                      Texas Instruments TLV320AIC23 CD quality codec driver
 *
 *	Based on the ibmcsi3k driver 
 *
 *      Copyright (C) 2002, Ken Inoue and David Gibson, IBM Corporation
 */

#ifndef __TLV320AIC23_INC__
#define __TLV320AIC23_INC__
