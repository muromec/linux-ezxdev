 ...
 * Added summary patch by Jiang Jun <a21079@motorola.com>
 * Modified for gc performance by Ru Yi <e5537c@motorola.com>
 *     changed the gc trigger condition, let it be triggered more easyly
 *
...
static void jffs2_calc_trigger_levels(struct jffs2_sb_info *c)
{
	...
	c->resv_blocks_gctrigger = c->resv_blocks_write + (c->nr_blocks / 10);
#else
